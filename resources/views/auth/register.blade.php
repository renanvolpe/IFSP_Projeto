    ...
    <div class="container">
        <div class="row">
            ...
            <div class="panel panel-default" id="painel-app">
                ...
                <div class="panel-heading" id="topo">
                    <h3 class="titulo" id="tituloform"> Cadastro
                        </h1>
                </div>
                        ...
                        <!-- Fim Linha com TRES labels -->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('bairro') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-5">
                                            <label for="bairro" class="col-md-5">Bairro:</label>
                                        ...
                                        <div class="form-group{{ $errors->has('cidade') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-5">
                                                <label for="cidade" class="col-md-5">Cidade:</label>
