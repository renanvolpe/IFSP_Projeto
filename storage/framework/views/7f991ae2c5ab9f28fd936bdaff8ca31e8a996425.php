...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul>
            <?php if(Route::has('login')): ?>
                ...
                <h6 class="a" id="corLogado"> Conta logada: <a href="<?php echo e(url('/home')); ?>" class="a" id="corLR"><?php echo e(Auth::user()->name); ?>



                        <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();" class="a" id="corSair"> <?php echo e(__('Sair')); ?>
    ...
    <ul>
        <?php else: ?>
        <a href="<?php echo e(route('login')); ?>" class="a" id="corLR">Login</a>

        <?php if(Route::has('register')): ?>
        <a href="<?php echo e(route('register')); ?>" class="a" id="corLogado">Cadastre-se</a>
        <?php endif; ?>
        <?php endif; ?>
        </div>
        <?php endif; ?>
...
The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.
 ...
 <a name="especialidades"> </a> <!-- referencia para buscar na pagina o conteudo selecionado no MENU -->
        ...
        Nossas especialidades:
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="<?php echo e(URL::to('/assets/especialidade.png')); ?>" style="width:80%">
                </div>
                <div class="col-md-8">
                    <p> Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum" (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..", comes from a line in section 1.10.32.
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <img src="<?php echo e(URL::to('/assets/especialidade2.png')); ?>" style="width:80%">
            ...
            <br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img src="<?php echo e(URL::to('/assets/cancerprostota.png')); ?>" style="width:50%">
                        <h5>Tratamento 1</h5>
                    </div>

                    <div class="col-md-4">
                        <img src="<?php echo e(URL::to('/assets/cancerbexiga.jpg')); ?>" style="width:50%">
                        <h5>Tratamento 2</h5>
                    </div>

                    <div class="col-md-4">
                        <img src="<?php echo e(URL::to('/assets/cancerrim.png')); ?>" style="width:30%">
                        <h5>Tratamento 3</h5>
                    </div>

                    <div class="col-md-4">
                        <img src="<?php echo e(URL::to('/assets/ejaculacaoprecoce.png')); ?>" style="width:30%">
                        <h5>Tratamento 4</h5>
                    </div>

                    <div class="col-md-4">
                        <img src="<?php echo e(URL::to('/assets/pedrarim.png')); ?>" style="width:50%">
                        <h5>Tratamento 5</h5>
                    </div>

                    <div class="col-md-4">
                        <img src="<?php echo e(URL::to('/assets/fimose.png')); ?>" style="width:30%">
                        <h5>Tratamento 6</h5>
                    </div>
...
</html><?php /**PATH C:\Users\joao-\Documents\GitHub\IFSP_Projeto\resources\views/welcome.blade.php ENDPATH**/ ?>